...
// Bump when the CLI or behavior change in any significant way. This will make
// files written by this version backward incompatible, forcing downstream
// users to update their pre-commit-go version.
const version = "0.4"
